...
export default function HomePage() {
  ...
  function handleSpendBlur() {
    setSpendInput(String(spendAmount));
  }
      ...
      {loading ? (
        ...
        <main className="flow-layout">
          ...
          <section className="recommendation-area">
            {ownedCards.length === 0 ? (
              <div className="card empty-state">Select your cards first.</div>
            ) : !hasSearch ? (
              <div className="card empty-state">Search a merchant or choose a category.</div>
            ) : bestResult ? (
              ...
              <div className="card empty-state">
                No sourced reward rule matches this spend. Check your issuer before relying on any benefit.
              </div>
            )}
          </section>
        </main>
